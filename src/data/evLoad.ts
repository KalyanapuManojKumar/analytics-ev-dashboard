...
/**
 * Parses a single CSV row (array of strings) into an EVRecord.
...
/**
 * Fetches and parses the EV population CSV from the public folder.
 * Returns an array of EVRecord; filters out rows with no VIN.
 */
